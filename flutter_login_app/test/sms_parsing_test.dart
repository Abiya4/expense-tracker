...
void main() {
  group('SmsService Parsing Logic', () {
    ...
    test('Valid HAM: Masked account (X1234)', () {
      String body = 'Your account XX1234 has been debited by Rs. 500.00 on 12-Feb-2024.';
      var result = SmsService.parseSms(body);
    ...
    test('Valid HAM: "sent to" + 12-digit ref', () {
      String body = 'Rs. 1000.00 sent to John Doe Ref No 123456789012 on 15-Jan-2024.';
      var result = SmsService.parseSms(body);
      expect(result, isNotNull);
    ...
    test('Valid HAM: "Sent to" (case insensitive) + 12-digit ref', () {
      String body = 'Sent to Jane Doe for dinner. Ref 987654321098. Debited Rs. 250';
      var result = SmsService.parseSms(body);
      expect(result, isNotNull);
    ...
    test('Spam: URL present', () {
      String body = 'Your account XX1234 has been debited. Click http://bit.ly/claim to claim reward.';
      var result = SmsService.parseSms(body);
    ...
    test('Valid HAM: Mixed case "SeNt To" + ref', () {
         String body = 'Amount of Rs 150.00 SeNt To UBER India. Ref No 112233445566.';
         var result = SmsService.parseSms(body);
         expect(result, isNotNull);
    ...
    test('Valid HAM: "sent via ... to" pattern (Federal Bank)', () {
      String body = 'Rs 50.00 sent via UPI on 17-02-2026 at 18:48:06 to ADNIXPRO TVPM.Ref:641448031517.Not you? Call 18004251199/SMS BLOCKUPI to 98950 88888 -Federal Bank';
      var result = SmsService.parseSms(body);
      expect(result, isNotNull, reason: "Should pars Federal Bank 'sent via...to' format");
